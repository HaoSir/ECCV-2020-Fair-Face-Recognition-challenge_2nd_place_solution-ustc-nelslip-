...
from util.utils import make_weights_for_balanced_classes_old, separate_irse_bn_paras, separate_resnet_bn_paras, warm_up_lr, schedule_lr, get_time,  AverageMeter, accuracy
...
if __name__ == '__main__':
    ...
    #     temp=img.resize((112//p,112//p))
    #     tempp=temp.resize((112,112))
    #     return tempp
    ...
    train_transform = transforms.Compose([ # refer to https://pytorch.org/docs/stable/torchvision/transforms.html for more build-in online data augmentation
        # transforms.Resize([112,112],interpolation=3), # smaller side resized
        ...
        # transforms.RandomResizedCrop((112,112),scale=(0.7,1.0),ratio=(0.75, 1.3333333333333333),interpolation=3),
    ...
    DISP_FREQ = len(train_loader) // 50 # frequency to display training loss & acc
    ...
    for epoch in range(NUM_EPOCH): # start training process
        ...
        for inputs, labels in tqdm(iter(train_loader)):
            ...
            if ((batch + 1) % DISP_FREQ == 0) and batch != 0:
                ...
                print("=" * 60)
                with open('work_space/log/save.txt','a+') as f:
                    f.write('Epoch {}/{} Batch {}/{}\t'
                            'Training Loss {loss.val:.4f} ({loss.avg:.4f})\t'
                            'Training Prec@1 {top1.val:.3f} ({top1.avg:.3f})\t'
        ...
        if MULTI_GPU:
            ...
            torch.save(HEAD.state_dict(), os.path.join(MODEL_ROOT, "Head_{}_Epoch_{}_Batch_{}_Time_{}_checkpoint.pth".format(HEAD_NAME, epoch + 1, batch, get_time())))
    torch.save(BACKBONE.module.state_dict(),'./work_space/models/save.pth')
